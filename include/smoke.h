...
#define VELOCITY_X_INDX	0.3
#define VELOCITY_Y_INDX	0.08
#define MAX_SCALE_X_INDX	30
#define MAX_SCALE_Y_INDX	30
#define MIN_SCALE_X_INDX	20
#define MIN_SCALE_Y_INDX	20
